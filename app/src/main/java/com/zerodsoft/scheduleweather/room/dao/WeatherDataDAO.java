...
public interface WeatherDataDAO {
	...
	@Query("UPDATE weather_data_table SET json = :json, downloaded_date = :downloadedDate, base_date_time = :baseDateTime WHERE latitude = :latitude" +
			" AND longitude = :longitude AND data_type = :dataType")
	void update(String latitude, String longitude, Integer dataType, String json, String downloadedDate, String baseDateTime);
