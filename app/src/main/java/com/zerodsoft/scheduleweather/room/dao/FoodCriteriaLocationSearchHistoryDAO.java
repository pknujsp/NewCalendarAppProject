...
public interface FoodCriteriaLocationSearchHistoryDAO
{
    ...
    void insertByEventId(Integer calendarId, Long eventId, String placeName, String addressName, String roadAddressName, String latitude, String longitude);
    ...
    void insertByInstanceId(Integer calendarId, Long instanceId, String placeName, String addressName, String roadAddressName, String latitude, String longitude);

    @Query("UPDATE food_criteria_location_search_history_table " +
            "SET place_name = :placeName , address_name = :addressName , road_address_name = :roadAddressName , latitude = :latitude , longitude = :longitude " +
            "WHERE calendar_id = :calendarId AND event_id = :eventId")
    void updateByEventId(Integer calendarId, Long eventId, String placeName, String addressName, String roadAddressName, String latitude, String longitude);

    @Query("UPDATE food_criteria_location_search_history_table " +
            "SET place_name = :placeName , address_name = :addressName , road_address_name = :roadAddressName , latitude = :latitude , longitude = :longitude " +
            "WHERE calendar_id = :calendarId AND instance_id = :instanceId")
    void updateByInstanceId(Integer calendarId, Long instanceId, String placeName, String addressName, String roadAddressName, String latitude, String longitude);
