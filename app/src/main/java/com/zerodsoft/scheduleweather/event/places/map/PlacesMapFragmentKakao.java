...
public class PlacesMapFragmentKakao extends KakaoMapFragment implements OnClickedPlacesListListener
{
    public static final String TAG = "PlacesMapFragmentKakao";
    ...
    public PlacesMapFragmentKakao(Fragment fragment)
    {
        super();
