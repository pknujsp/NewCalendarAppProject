package com.zerodsoft.scheduleweather.event.places.bottomsheet;
...
public class PlaceBottomSheetBehaviour<V extends View> extends BottomSheetBehavior<V>
{
     ...
     */
    public PlaceBottomSheetBehaviour()
    {
    }
     ...
     */
    public PlaceBottomSheetBehaviour(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    /**
     * A utility function to get the {@link PlaceBottomSheetBehaviour} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link PlaceBottomSheetBehaviour}.
     * @return The {@link PlaceBottomSheetBehaviour} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> PlaceBottomSheetBehaviour<V> from(V view)
    {
