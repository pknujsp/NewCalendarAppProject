package com.zerodsoft.scheduleweather.navermap.bottomsheet;
...
public class PlacesListBottomSheetBehavior<V extends View> extends BottomSheetBehavior<V>
{
    ...
    /**
     * Default constructor for instantiating PlaceBottomSheetBehaviour.
     */
    public PlacesListBottomSheetBehavior()
    {
    }

    /**
     * Default constructor for inflating PlaceBottomSheetBehaviour from layout.
     *
     * @param context The {@link Context}.
     * @param attrs   The {@link AttributeSet}.
     */
    public PlacesListBottomSheetBehavior(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection)
    {
        ...
        } else if ((mHideable && mState == STATE_HIDDEN) || mState == STATE_HIDDEN)
        {
    ...
    public final void setState(@State final int state)
    {
        ...
        if (mViewRef == null)
        {
            ...
            if (state == STATE_COLLAPSED || state == STATE_EXPANDED || state == STATE_HALF_EXPANDED ||
                    ((mHideable && state == STATE_HIDDEN) || state == STATE_HIDDEN))
            {
                mState = state;
            }
            return;
    ...
    void startSettlingAnimation(View child, int state)
    {
        ...
        {
            top = mMinOffset;
        } else if ((mHideable && state == STATE_HIDDEN) || state == STATE_HIDDEN)
        {
            top = mParentHeight;
        } else
        {
    ...
    /**
     * A utility function to get the {@link PlacesListBottomSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link PlacesListBottomSheetBehavior}.
     * @return The {@link PlacesListBottomSheetBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> PlacesListBottomSheetBehavior<V> from(V view)
    {
        ...
        if (!(behavior instanceof PlacesListBottomSheetBehavior))
        {
            throw new IllegalArgumentException("The view is not associated with PlaceBottomSheetBehaviour");
        }
        return (PlacesListBottomSheetBehavior<V>) behavior;
    }
}