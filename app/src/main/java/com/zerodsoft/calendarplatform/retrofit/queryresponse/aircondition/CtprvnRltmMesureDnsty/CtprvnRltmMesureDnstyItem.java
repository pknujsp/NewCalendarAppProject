...
public class CtprvnRltmMesureDnstyItem implements Parcelable
{
    @Expose
    ...
    protected CtprvnRltmMesureDnstyItem(Parcel in)
    {
    ...
    public static final Creator<CtprvnRltmMesureDnstyItem> CREATOR = new Creator<CtprvnRltmMesureDnstyItem>()
    {
        @Override
        public CtprvnRltmMesureDnstyItem createFromParcel(Parcel in)
        {
            return new CtprvnRltmMesureDnstyItem(in);
        }

        @Override
        public CtprvnRltmMesureDnstyItem[] newArray(int size)
        {
            return new CtprvnRltmMesureDnstyItem[size];
        }
    };
