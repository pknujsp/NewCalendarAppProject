...
import com.zerodsoft.calendarplatform.retrofit.queryresponse.weather.midlandfcstresponse.MidLandFcstItem;
import com.zerodsoft.calendarplatform.retrofit.queryresponse.weather.midlandfcstresponse.MidLandFcstItems;
import com.zerodsoft.calendarplatform.retrofit.queryresponse.weather.midtaresponse.MidTaItem;
import com.zerodsoft.calendarplatform.retrofit.queryresponse.weather.midtaresponse.MidTaItems;
...
public class MidFcstResult {
	...
	private List<MidFcstFinalData> midFcstFinalDataList;
	//중기육상예보 응답 데이터
	...
	*/
	public void setMidFcstDataList(MidLandFcstItems midLandFcstItems, MidTaItems midTaItems, Date downloadedDate, Date baseDateTime) {
		...
		List<MidFcstFinalData> midFcstFinalDataList = new ArrayList<>();
		
		//3일 후로 이동
		copiedCalendar.add(Calendar.DAY_OF_YEAR, 3);
		
		midFcstFinalDataList.add(new MidFcstFinalData(ClockUtil.MdE_FORMAT.format(copiedCalendar.getTime()), midLandFcstData.getWf3Am(),
		...
		midFcstFinalDataList.add(new MidFcstFinalData(ClockUtil.MdE_FORMAT.format(copiedCalendar.getTime()), midLandFcstData.getWf4Am(),
		...
		midFcstFinalDataList.add(new MidFcstFinalData(ClockUtil.MdE_FORMAT.format(copiedCalendar.getTime()), midLandFcstData.getWf5Am(),
		...
		midFcstFinalDataList.add(new MidFcstFinalData(ClockUtil.MdE_FORMAT.format(copiedCalendar.getTime()), midLandFcstData.getWf6Am(),
		...
		midFcstFinalDataList.add(new MidFcstFinalData(ClockUtil.MdE_FORMAT.format(copiedCalendar.getTime()), midLandFcstData.getWf7Am(),
		...
		midFcstFinalDataList.add(
				new MidFcstFinalData(ClockUtil.MdE_FORMAT.format(copiedCalendar.getTime()), midLandFcstData.getWf8(), midLandFcstData.getRnSt8(),
						midTaFcstData.getTaMin8(), midTaFcstData.getTaMax8()));
		
		copiedCalendar.add(Calendar.DAY_OF_YEAR, 1);
		
		midFcstFinalDataList.add(
				new MidFcstFinalData(ClockUtil.MdE_FORMAT.format(copiedCalendar.getTime()), midLandFcstData.getWf9(), midLandFcstData.getRnSt9(),
						midTaFcstData.getTaMin9(), midTaFcstData.getTaMax9()));
		
		copiedCalendar.add(Calendar.DAY_OF_YEAR, 1);
		
		midFcstFinalDataList.add(new MidFcstFinalData(ClockUtil.MdE_FORMAT.format(copiedCalendar.getTime()), midLandFcstData.getWf10(),
				midLandFcstData.getRnSt10(), midTaFcstData.getTaMin10(), midTaFcstData.getTaMax10()));
		
		this.midFcstFinalDataList = midFcstFinalDataList;
	}
	...
	public List<MidFcstFinalData> getMidFcstFinalDataList() {
