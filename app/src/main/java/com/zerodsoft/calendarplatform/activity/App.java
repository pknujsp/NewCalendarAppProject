package com.zerodsoft.calendarplatform.activity;
...
import com.zerodsoft.calendarplatform.notification.receiver.EventAlarmReceiver;
...
public class App extends android.app.Application {
	...
	private static NaverMap.MapType preference_key_map_type;
	...
	public static void setAppSettings(Context context) {
		...
		if (preferences.getAll().isEmpty()) {
			...
			//지도 기본 유형 설정
			preference_key_map_type = NaverMap.MapType.Basic;
			editor.putString(context.getString(R.string.preference_key_map_type), preference_key_map_type.toString());
			...
			preference_key_map_type = NaverMap.MapType.valueOf(preferences.getString(context.getString(R.string.preference_key_map_type),
	...
	public static NaverMap.MapType getPreference_key_map_type() {
		return preference_key_map_type;
	}

	public static void setPreference_key_map_type(NaverMap.MapType preference_key_map_type) {
		App.preference_key_map_type = preference_key_map_type;
	}
}
